...
namespace Pessoa
{
    class Pessoa
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Aluno\source\repos\Pessoa\Pessoa\Database1.mdf;Integrated Security=True");
